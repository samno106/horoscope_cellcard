...
class PhoneNumberHoroscopePage extends StatefulWidget {
  const PhoneNumberHoroscopePage({super.key});

  @override
  State<PhoneNumberHoroscopePage> createState() =>
      _PhoneNumberHoroscopePageState();
}

class _PhoneNumberHoroscopePageState extends State<PhoneNumberHoroscopePage> {
                  ...
                  children: <Widget>[
                    ...
                    const Positioned(
                      ...
                      child: SizedBox(
                        ...
                        child: Image(
                            image:
                                AssetImage('/images/vector/phone_vector.png')),
                      ),
                    ),
                    Positioned(
